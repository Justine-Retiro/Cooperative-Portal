            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/coop/master/repositories/repositories.php" class="text-decoration-none">Repositories</a></li>
                ...
                <div class="row" style="margin-top: 2em;">
                  ...
                  <!-- Table -->
                  <form id="memberForm" action="/coop/master/repositories/api/newEntry.php" method="post" onsubmit="return validateForm()">                  
                  <div class="row">
                  ...
                  <button class="btn btn-success btn-lg" id="toast-submit" type="submit" style="float: right;">Save</button>
                  </form>
                  <!-- /Table -->
...
<!-- Fetching data -->
<script src="/coop/master/repositories/static/fetch.js"></script>
<!-- Clipboard -->
<script src="/coop/master/repositories/static/clipboard.js"></script>
<!-- Toaster Alert -->
<script>
// Toaster
// Form submission
...
$(document).ready(function() {
  $("#memberForm").on("submit", function(e) {
    ...
    // AJAX request
    $.ajax({
      url: "/coop/master/repositories/api/newEntry.php",
      type: "post",
      data: $(this).serialize(),
      success: function() {
        ...
        setTimeout(function() {
          window.location.href = "/coop/master/repositories/repositories.php";
