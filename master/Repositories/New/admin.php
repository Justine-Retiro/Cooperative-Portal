            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="row" style="margin-top: 2em;">
                  ...
                  <!-- Table -->
                  <form id="memberForm" action="/coop/master/repositories/api/newAdmin.php" method="post" onsubmit="return validateForm()">                  
...
$(document).ready(function() {
  $("#memberForm").on("submit", function(e) {
    ...
    // AJAX request
    $.ajax({
      url: "/coop/master/repositories/api/newAdmin.php",
      type: "post",
      data: $(this).serialize(),
      success: function() {
