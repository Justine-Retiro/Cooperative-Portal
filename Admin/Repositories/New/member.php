            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="row" style="margin-top: 2em;">
                  ...
                  <!-- Table -->
                  <form id="memberForm" action="/coop/Admin/Repositories/api/newEntry.php" method="post" onsubmit="return validateForm()">                  
                  <div class="row">
...
$(document).ready(function() {
  $("#memberForm").on("submit", function(e) {
    ...
    // AJAX request
    $.ajax({
      url: "/coop/Admin/Repositories/api/newEntry.php",
      type: "post",
      data: $(this).serialize(),
      success: function() {
        ...
        setTimeout(function() {
          window.location.href = "/coop/Admin/Repositories/repositories.php";
